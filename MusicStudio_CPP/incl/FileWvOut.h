...
class FileWvOut : public WvOut
{
  ...
  */
  ...
  //! Output two samples to appropriate stereo channels in a sample frame.
  /*!
    An StkError is thrown if an output error occurs, or not a stereo file
  */
  void stereoTick( const StkFloat sampleChannelOne, const StkFloat sampleChannelTwo );
